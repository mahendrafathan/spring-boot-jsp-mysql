<%-- 
    Document   : index
    Created on : Mar 20, 2019, 6:23:34 PM
    Author     : Owner
--%>
...
<html lang="en">
    <head>
        ...
        <!-- Favicons -->
        <link href="resources/portal/img/favicon.png" rel="icon">
        <link href="resources/portal/img/apple-touch-icon.png" rel="apple-touch-icon">

        <!-- Google Fonts -->
        <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,700,700i|Raleway:300,400,500,700,800|Montserrat:300,400,700" rel="stylesheet">

        <!-- Bootstrap CSS File -->
        <link href="resources/portal/lib/bootstrap/css/bootstrap.min.css" rel="stylesheet">

        <!-- Libraries CSS Files -->
        <link href="resources/portal/lib/font-awesome/css/font-awesome.min.css" rel="stylesheet">
        <link href="resources/portal/lib/animate/animate.min.css" rel="stylesheet">
        <link href="resources/portal/lib/ionicons/css/ionicons.min.css" rel="stylesheet">
        <link href="resources/portal/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">
        <link href="resources/portal/lib/magnific-popup/magnific-popup.css" rel="stylesheet">
        <link href="resources/portal/lib/ionicons/css/ionicons.min.css" rel="stylesheet">

        <!-- Main Stylesheet File -->
        <link href="resources/portal/css/style.css" rel="stylesheet">
    ...
    <body id="body">
        ...
        <header id="header">
            <div class="container">
                ...
                <div id="logo" class="pull-left">
                    <h1><a href="#body" class="scrollto">Sangga Data <span>Nusantara</span></a></h1>
                    <!-- Uncomment below if you prefer to use an image logo -->
                    <!-- <a href="#body"><img src="resources/portal/img/logo.png" alt="" title="" /></a>-->
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 about-img">
                            <img src="resources/portal/img/about-img.jpg" alt="">
                        </div>
                        ...
                        <section id="clients" class="wow fadeInUp">
                            <div class="container">
                                ...
                                <div class="owl-carousel clients-carousel">
                                    <img src="resources/portal/img/clients/client-1.png" alt="">
                                    <img src="resources/portal/img/clients/client-2.png" alt="">
                                    <img src="resources/portal/img/clients/client-3.png" alt="">
                                    <img src="resources/portal/img/clients/client-4.png" alt="">
                                    <img src="resources/portal/img/clients/client-5.png" alt="">
                                    <img src="resources/portal/img/clients/client-6.png" alt="">
                                    <img src="resources/portal/img/clients/client-7.png" alt="">
                                    <img src="resources/portal/img/clients/client-8.png" alt="">
                                </div>
                            ...
                            <div class="container">
                                ...
                                <div class="owl-carousel testimonials-carousel">
                                    ...
                                    <div class="testimonial-item">
                                        <p>
                                            <img src="resources/portal/img/quote-sign-left.png" class="quote-sign-left" alt="">
                                            Proin iaculis purus consequat sem cure digni ssim donec porttitora entum suscipit rhoncus. Accusantium quam, ultricies eget id, aliquam eget nibh et. Maecen aliquam, risus at semper.
                                            <img src="resources/portal/img/quote-sign-right.png" class="quote-sign-right" alt="">
                                        </p>
                                        <img src="resources/portal/img/testimonial-1.jpg" class="testimonial-img" alt="">
                                        <h3>Saul Goodman</h3>
                                        <h4>Ceo &amp; Founder</h4>
                                    </div>
                                    ...
                                    <div class="testimonial-item">
                                        ...
                                        <img src="resources/portal/img/testimonial-2.jpg" class="testimonial-img" alt="">
                                        <h3>Sara Wilsson</h3>
                                        <h4>Designer</h4>
                                    </div>
                                    ...
                                    <div class="testimonial-item">
                                        ...
                                        <img src="resources/portal/img/testimonial-3.jpg" class="testimonial-img" alt="">
                                        <h3>Jena Karlis</h3>
                                        <h4>Store Owner</h4>
                                    </div>
                                    ...
                                    <div class="testimonial-item">
                                        ...
                                        <img src="resources/portal/img/testimonial-4.jpg" class="testimonial-img" alt="">
                                        <h3>Matt Brandon</h3>
                                        <h4>Freelancer</h4>
                                    </div>
                                    ...
                                    <div class="testimonial-item">
                                        ...
                                        <img src="resources/portal/img/testimonial-5.jpg" class="testimonial-img" alt="">
                                        <h3>John Larson</h3>
                                        <h4>Entrepreneur</h4>
                                    </div>
                            ...
                            <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-6">
                                        <div class="member">
                                            <div class="pic"><img src="resources/portal/img/team-1.jpg" alt=""></div>
                                            <div class="details">
                                                <h4>Walter White</h4>
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="member">
                                            <div class="pic"><img src="resources/portal/img/team-2.jpg" alt=""></div>
                                            <div class="details">
                                                <h4>Sarah Jhinson</h4>
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="member">
                                            <div class="pic"><img src="resources/portal/img/team-3.jpg" alt=""></div>
                                            <div class="details">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="member">
                                            <div class="pic"><img src="resources/portal/img/team-4.jpg" alt=""></div>
                                            <div class="details">
                                                <h4>Amanda Jepson</h4>
        ...
        <script src="resources/portal/lib/jquery/jquery.min.js"></script>
        <script src="resources/portal/lib/jquery/jquery-migrate.min.js"></script>
        <script src="resources/portal/lib/bootstrap/js/bootstrap.bundle.min.js"></script>
        <script src="resources/portal/lib/easing/easing.min.js"></script>
        <script src="resources/portal/lib/superfish/hoverIntent.js"></script>
        <script src="resources/portal/lib/superfish/superfish.min.js"></script>
        <script src="resources/portal/lib/wow/wow.min.js"></script>
        <script src="resources/portal/lib/owlcarousel/owl.carousel.min.js"></script>
        <script src="resources/portal/lib/magnific-popup/magnific-popup.min.js"></script>
        <script src="resources/portal/lib/sticky/sticky.js"></script>

        <!-- Contact Form JavaScript File -->
        <script src="resources/portal/contactform/contactform.js"></script>

        <!-- Template Main Javascript File -->
        <script src="resources/portal/js/main.js"></script>
